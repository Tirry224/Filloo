...
« cocher la case remplit la file de notifications » ; sans `0022`, sur
« client suspendu : le fil est ferme a l'ecriture ». Ces quatre-là ont été
vérifiés en omettant réellement la migration, pas supposés.
