...
| 26 | Ma boutique | Écran de CONSULTATION : on y lit ses informations et on y trouve le compte (bascule vers le client lié, déconnexion), le panneau « Notifications » et celui du mot de passe. |
